...
public class SectionListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        SectionItem sectionItem = this.sections.get(groupPosition).getSectionItems().get(childPosition);
        ...
        itemIcon.setImageDrawable(getDrawableByName(sectionItem.getIcon(), this.context));

        return convertView;
    }

    private Drawable getDrawableByName(String name, Context context) {
